...
export default function KolektorPopup(props) {
  //state Customer ID
      ...
      const res = await axios
        .get(
          `${process.env.REACT_APP_DOMAIN_API}` +
            `/EmployeeReps/DropDown/EmployeeCollector?branch=${getBrach()}`,
          GetConfig()
        )
  ...
  return (
    <React.Fragment>
      ...
      >
        <DialogTitle id="form-dialog-title">Select Kolektor</DialogTitle>
        <DialogContent>
          <Grid container md={12}>
            <Grid item md={6} xs={12}>
              <DialogContentText>Kolektor List</DialogContentText>
            </Grid>
            <Grid item md={6} xs={12}>
              <TextField
                variant="standard"
