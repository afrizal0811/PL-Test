  ...
  const getDataPrincipal = async () => {
    ...
    try {
      const res = await axios
        .get(
          `${process.env.REACT_APP_DOMAIN_API_BARU}/master/ProductGroup/Kelompok/${props.ProductPrincipalID}/${props.ProductGroupID}`,
          GetConfig()
        )
        ...
        <Grid container spacing={3} md={12} mt={2}>
          <div style={{ height: 300, width: "100%" }}>
            <DataGrid
              ...
              //   props.setProductKelompokID(SelectedPrincipal[0]);
              // }}
